...
vqe_energy = -67.29218736934352  # From your run
exact_energy = -67.43722115819506  # Replace if you have it

absolute_error = abs(vqe_energy - exact_energy)
print(f"Absolute Error: {absolute_error} Hartree")

relative_error = (absolute_error / abs(exact_energy)) * 100
print(f"Relative Error: {relative_error:.4f} %")

# VQE and Exact Energy
vqe_energy = -67.29218736934352
exact_energy = -67.43722115819506

# Absolute Error
absolute_error = abs(vqe_energy - exact_energy)

# Accuracy %
accuracy = (1 - (absolute_error / abs(exact_energy))) * 100
print(f"VQE Accuracy: {accuracy:.4f} %")